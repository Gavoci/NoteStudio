            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        ?>
                        <form action="php/update_user.php" class="row g-3" method="post">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="age" id="age" class="form-control"
                                    value="<?php echo htmlspecialchars($userData['age']); ?>" required min="8" max="120">
                                <?php if ($userData['age'] < 8 || $userData['age'] > 120) : ?>
                                    <div class="invalid-feedback">Age must be between 8 and 120.</div>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
