...
INNER JOIN users ON users.user_id = notes.note_user
WHERE (
    (note_title LIKE '$searchTerm' OR note_tags LIKE '$searchTerm') 
    AND note_privacy = 0 AND notes_status = 0
)
OR (
    (note_title LIKE '$searchTerm' OR note_tags LIKE '$searchTerm') 
    AND note_privacy = 1 AND note_user = $userId AND notes_status = 0
)
...
if ($FetchNotesDetailsresult->num_rows > 0) {
    ...
    <main>
        <div class="container my-4">
            ...
            <h5 class="fw-bold my-3">Search Results For "
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12 col-lg-8">
                                        <a href="view_notes.php?noteId=<?= $id ?>" class="notesTitleLink">
                                        ...
                                        <div class="col-lg-3 d-none d-lg-block">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="edit_notes.php?noteId=<?= $id ?>"><i
        ...
        <div class="container my-4">
            ...
            <div class="card rounded-4 border shadow-sm">
                <div class="card-body text-center">
                    <h6 class="fw-bold">No search results found for "
                        <?php echo $_GET['search'] ?>"
                    </h6>
                </div>
            </div>
