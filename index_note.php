    ...
    <div class="container">
        <form method="post" id="searchForm" class="mb-3">
            <div class="input-group">
                <input type="text" class="form-control" name="searchTerm" id="searchTerm" placeholder="Cerca per titolo">
        ...
        <table class="table table-hover text-center" id="studentTable">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">n_caratteri</th>
                    <th scope="col">studente_ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row["n_caratteri"] ?></td>
                    <td><?php echo $row["studente_ID"] ?></td>
